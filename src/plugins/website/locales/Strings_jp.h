...
#define L_AXPN_STEPS_PER_DEG "ステップ数/度"
#define L_AXPN_LIMIT_DEGS_MIN "最小リミット, 度"
#define L_AXPN_LIMIT_DEGS_MAX "最大リミット, 度"
#define L_AXPN_STEPS_PER_UM "ステップ数/um"
#define L_AXPN_LIMIT_UM_MIN "最小リミット, um"
#define L_AXPN_LIMIT_UM_MAX "最大リミット, um"
#define L_AXPN_REVERSE "反転(Reverse)"
#define L_AXPN_MICROSTEPS "マイクロステップ"
#define L_AXPN_MICROSTEPS_GOTO "導入時マイクロステップ"
#define L_AXPN_DECAY_MODE "Decayモード"
#define L_AXPN_DECAY_MODE_GOTO "Decayモード(Goto時)"
#define L_AXPN_CURRENT_HOLD "電流(mA) 保持時"
#define L_AXPN_CURRENT_RUN "電流(mA) 追尾時"
#define L_AXPN_CURRENT_GOTO "電流(mA) 導入時"
#define L_AXPN_INTERPOLATE "256x 補間"
#define L_AXPN_PID_P "<big><code>P</code></big> 追尾"
#define L_AXPN_PID_I "<big><code>I</code></big> 追尾"
#define L_AXPN_PID_D "<big><code>D</code></big> 追尾"
#define L_AXPN_PID_SLEWING_P "<big><code>P</code></big> スルー"
#define L_AXPN_PID_SLEWING_I "<big><code>I</code></big> スルー"
#define L_AXPN_PID_SLEWING_D "<big><code>D</code></big> スルー"
#define L_AXPN_RADS_PER_COUNT "Rads/カウント"
#define L_AXPN_STEPS_TO_COUNTS "ステップ/カウント比"
#define L_AXPN_MAX_ACCEL "最大加速度, %/s/s"
#define L_AXPN_MIN_PWR "最小パワー, %"
#define L_AXPN_MAX_PWR "最大パワー, %"
